...
public class UserServlet extends BaseServlet {
    ...
    private void login(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user != null) {
            ...
            List<Module> userModules = userService.findModuleByUserId(user.getId());
            request.getSession().setAttribute("modules",userModules);

            StringBuilder curls= new StringBuilder();
            for (Module userModule : userModules) {
                String curl = userModule.getCurl();
                curls.append(curl).append(",");
            }
            request.getSession().setAttribute("curls", curls.toString());

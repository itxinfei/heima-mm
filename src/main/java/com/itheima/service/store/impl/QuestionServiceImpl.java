...
public class QuestionServiceImpl implements QuestionService {
    ...
    public ByteArrayOutputStream getReport() throws IOException {
        ...
        String[] fields = {"题目ID", "所属公司ID", "所属目录ID", "题目简介", "题干描述",
                "题干配图", "题目分析", "题目类型", "题目难度", "是否经典题", "题目状态", "审核状态","答案"};
        ...
        for (Question q : list) {
            ...
            Cell cell_data_13 = row_temp.createCell(1 + cell_index);
            cell_data_13.setCellValue(q.getReviewStatus());    //++
            cell_data_13.setCellStyle(cs_field);
        }

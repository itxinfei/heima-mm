...
<script src="${ctx}/plugins/jQueryUI/jquery-ui.min(1).js"></script>
<script>
...
<script src="${ctx}/plugins/fastclick/fastclick(1).js"></script>
...
<script src="${ctx}/plugins/input-mask/jquery.inputmask(1).js"></script>

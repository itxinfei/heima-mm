...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <%--                            <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>--%>
            <%--                        </a>--%>
            <%--                        <c:forEach items="${userModules}" var="module2">--%>
            <%--                            <c:if test="${module2.ctype==1 && module2.parentId==module.id}">--%>
            <%--                                <ul class="treeview-menu">--%>
            <%--                                    <li id="sys-dept">--%>
            <%--                                        <a href="${ctx}/system/dept?operation=list" onclick="setSidebarActive(this)"--%>
            <%--                                           target="iframe">--%>

...
Page({
  ...
  loadQuestions() {
    let _this = this
    console.log("category:type:" + _this.data.categoryType);
    console.log("category:id:" + _this.data.currentKindId);
    let data = {
      categoryType: _this.data.currentTypeId,
  ...
  loadSwitchData: function (e) {
    ...
    console.log("loadSwitchData:" + e.detail.val);
    let _this = this
    let data = {
      categoryType: 101,
  ...
  changPage: function (e) {
    ...
    console.log("changPage:"+dataType);
    this.setData({
      onContent: dataType
    })
    if (dataType === "103") {
